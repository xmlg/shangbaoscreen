"use strict";
angular.module("countryHotnewsModule", ["ngAnimate", "httpServerModule"])
    .controller("countryHotnewsCtrl", ["$scope", "$q", "$sce", "http", "$timeout", function($scope, $q, $sce, http, $timeout) {
        initStatus();
        initData();
        /**
