zbdp.initSentiment = function() {
    ...
    var sentimentUrl = "./json/sentiment.json";
...
zbdp.updateSentiment = function() {
    var id = zbdp.getUrlParams("id");
    var scene_level = zbdp.getUrlParams("scene_level");
    var sentimentUrl = serverDomain + '/screen/globalsen/sentiment?page_no=1&page_size=' + zbdp.configData.pageSize + '&id=' + id + '&scene_level=' + scene_level;
