(function() {
    ...
    zbdp.configData = {
         ...
         * 新闻配置项
         */
        'moveVerticalDelay': 7000, //单位（ms）,垂直滚动间隔
        'moveHorizontalSpeed': 100, //单位（像素/s）,水平滚动速度
        'moveHorizontalDelay': 2000, //单位（ms）,水平滚动间隔
        'topItemsThreshold': 5, //单位（条）,置顶的信息条目最多显示的数量，且不会垂直滚动
        'todayUpdateInterval': 3000, //单位（s），新华社微信更新间隔
        'groupUpdateInterval': 3600, //单位（s），全国微信更新间隔

        /**
         * 突发线索配置项
         */
        'checkEmergencyInterval': 60, //单位（s），检查是否有热点信息的时间间隔
        'showEmergencyDur': 15, //单位（s），热点信息窗口显示时长
        'toggleEmergencyInterval': 10, //单位（s），显示下个热点信息的间隔
