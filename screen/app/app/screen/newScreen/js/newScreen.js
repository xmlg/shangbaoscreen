...
$(function(){
    ...
    var provinceUrl = "/cas/casData/screenJson?type=threeProvinceCei";//72小时省份影响力url
    var checkR;//用于稿件id判断
    //监测点击最大化事件
    ...
    function top_click(){
        $("#trans-center").contents().find(".td2").click(function(){
            window.open("/screen/keyManuscriptAnalysis/index.html?id="+this.id,"_blank")
            // var id=$(this).attr("id");
            //console.log(id);
    ...
    function getEventInfo(id){
        var url = "/wcm/bigdata.do?modelid=getEventIntroForBig&serviceid=eventtrace&topvalue=5&typeid=event&user_id=admin&department=admin&eventid="+id;
        $.ajax({
            url: url,
            data: {},
            type: "get",
    ...
    function getEventLists(id){
        ...
        var url = "/wcm/bigdata.do?modelid=getEventInnerList&serviceid=eventtrace&pageNo=1&pageSize=10&typeid=event&user_id=admin&department=admin&eventid="+id;
   ...
   function getEvents(){
       var events;
       var url = "/wcm/bigdata.do?event_type=public&eventid=0&key_word=&modelid=hoteventlist&page_no=0&page_size=10&serviceid=eventmgr&typeid=event&user_id=admin&department=admin";
    ...
    var update=function(t){
        ...
        //console.log(title);
        if(t == 3){
            provinceUrl = "/cas/casData/screenJson?type=threeProvinceCei";
            //provinceUrl = "/cas/casData/screenJson?type=provinceCei";
            title.text("72小时稿件影响力排行TOP10")
        }else if(t == 1){
            provinceUrl = "/cas/casData/screenJson?type=oneProvinceCei";
            title.text("24小时稿件影响力排行TOP10")
        }else if(t == 7){
            provinceUrl = "/cas/casData/screenJson?type=sevenProvinceCei";
            title.text("近7天稿件影响力排行TOP10")
        }else if(t == 30){
            provinceUrl = "/cas/casData/screenJson?type=thirtyProvinceCei";
