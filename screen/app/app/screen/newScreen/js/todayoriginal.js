...
App.prototype.requestData = function() {
    ...
    if(zbGuid==null &&pubTimeStart==null&&pubTimeEnd==null){
        //url = '/cas/casData/screenJson?type=ThreedaysArticle';  //72小時
         url = '/cas/casData/screenJson?type=OnedayArticle';  //24小時
    }else{
         url = '/cas/xhs/bigScreen/main.do?method=getArticleSearch&zbGuid='+zbGuid+"&pubTimeStart="+pubTimeStart+"&pubTimeEnd="+pubTimeEnd;
    }
    //url='../map/json/getArticleSearch.json'
