...
! function(a, b) {
	...
	return b.prototype = {
		...
		_generatePath: function(a, b, c, d) {
			...
			return e.setAttribute("class", "pathClass"), e.setAttribute("fill", "transparent"), e.setAttribute("stroke", c), e.setAttribute("stroke-width", this._strokeWidth), e.setAttribute("d", this._calculatePath(a, b)), e.setAttribute("class", d), this._svg.appendChild(e), this
		},
