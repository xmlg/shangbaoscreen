zbdp.loadEmergency = function() {
    ...
    var emergencyUrl = serverDomain + '/screen/disasterEmergency/get?id=' + id + '&scene_level=' + scene_level;
    // var emergencyUrl = "/wcm/bigdata.do?day=06&groupname_type=4&modelid=get&month=02&page_no=0&page_size=10&serviceid=todayinhistory";
