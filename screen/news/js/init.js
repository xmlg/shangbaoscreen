(function() {
    ...
    zbdp.configData = {
         ...
         * 新闻配置项
         */
        'moveVerticalDelay': 42, //单位（ms）,垂直滚动间隔
        'moveHorizontalSpeed': 50, //单位（像素/s）,水平滚动速度
        'moveHorizontalDelay': 500, //单位（ms）,水平滚动间隔
        'topItemsThreshold': 5, //单位（条）,置顶的信息条目最多显示的数量，且不会垂直滚动
        'todayUpdateInterval': 400, //单位（s），今日政策更新间隔
        'groupUpdateInterval': 400, //单位（s），集团舆情更新间隔
        'historyUpdateInterval': 400, //单位（s），集团舆情更新间隔
