(function() {
    ...
    App.prototype.getListData = function() {
        ...
        $.get('/isearch/front/search.jhtml?code=551b1ff558194a0eb61d171ef40f3085&pageNumber=1&pageSize=10&searchWord=&type=35&&fastTime='+today+',&dayOrder=desc', function(data) {
    ...
    App.prototype.appendList = function(data) {
        ...
        var data_text = data.title?data.title: 'null';
        ...
        if(data.date.indexOf('-')==-1){
            ...
            main_child.append("<div class='item'><div class='item_name'><span class='item_from'>" + data.source + "</span><span class='item_time'>   " + data.date + "</span></div><div class='item_logo'><img src="+showImg(data.dbName)+"></div><div class='item_main'>" + data_text  + "</div></div>")
    }
