...
App.prototype.requestData = function() {
    ...
    var url = '/wcm/bigdata.do?modelid=hotpoint&serviceid=areahotpoint&loaddate='+today+'&area=001013';
...
App.prototype.renderList = function(data) {
	...
	update.each(function(d, i) {
        ...
        d3.select(this).select('.source').text(d.AREANAME);
...
App.prototype.scrolleOnFocusText = function(text) {
	window.setTimeout(function() {
		...
		if (containerWidth < textWidth) {
			$text.animate({
				left: textWidth - containerWidth + 475 + 'px'
			}, {
