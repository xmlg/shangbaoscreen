...
App.prototype.requestData = function() {
    ...
    // var url = serverDomain + '/wcm/bigdata.do?area=001013013&cluster_name=country_1&field=000&loaddate=' + today + '&modelid=hotnewslist&pagesize=10&serviceid=areahotpoint&startpage=0&subjectarea=0&typeid=widget';
    var url = '/bigScreen/hotspot/area?areaCode=001013013';
...
App.prototype.renderList = function(data) {
    ...
    update.each(function(d, i) {
        ...
        d3.select(this).select('.source').text(d.tippingMedia || "其它");
