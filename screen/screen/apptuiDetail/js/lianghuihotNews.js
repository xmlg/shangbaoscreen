...
(function() {
    ...
    Hotnews.prototype.getHotnews = function(success) {
        ...
        if(GetQueryString('type') == 'all'){
            url = "/xhs/wcm/bigdata.do?clusterid="+GetQueryString('clusterid')+"&entityfield=MAXMEDIAREPORT&modelid=hotArtticleList&page_no=0&page_size=10&serviceid=hotpointevent&typeid=widget";
        }
    ...
    function getDocDetail($liDom) {
        ...
        HS.httpServer("/xhs/wcm/bigdata.do?modelid=hotPonitEventDetail&serviceid=hotpointevent1&typeid=widget", params, "get").done(function(data) {
