zbdp.initDrawMap = function(dataArr) {
    ...
    TMOption.scale = scale;
    var twinkleManager = new TwinkleManager(TMOption);
    twinkleManager.update(meteorData);
    //获取页面真实的缩放比例,修复闪烁偏移bug
    function getScale(){
        return parseFloat($("body").css("-webkit-transform").split(",")[3].replace(/ /, ""));
    }
