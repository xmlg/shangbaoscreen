define(function(require) {
    ...
    var SubMediaMatrix = require('subscenes/mediaMatrix/SubMediaMatrix');
    var CenterLogo = require('subscenes/other/components/CenterLogoNew');

    function Scene() {
        this.snapElement = Snap("#svg");
        this.centerLogo = new CenterLogo();
        ...
        this.subMediaMatrix = new SubMediaMatrix(this);
    }

    Scene.prototype.init = function() {
        var self = this;
        this.centerLogo.init();
