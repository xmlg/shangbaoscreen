define(function(require) {
    ...
    function SubSceneCollect(parent) {
        ...
        var cai = data.MATERAILNUM + data.ORGINAL.TOTAL;
        var yuan = data.TOTAL - cai;
        this.mainLabelDouble = new MainLabelDouble(this, '源', yuan, '采', cai);
        this.mainLabelDouble.setPosition(1295.5, 137.5);
        ...
        this.pathWay0 = new PathWay(this, 'M45 -28 45 -132 65 -147 853 -147 867 -127 867 -28', pathWayStyle);
    ...
    SubSceneCollect.prototype.runPathWay = function(data, newData, ms) {
        ...
        if (newData.MATERAILNUM - data.MATERAILNUM > 0) {
            util.sliceNumber(newData.MATERAILNUM - data.MATERAILNUM, 5).forEach(function(d, i) {
                ...
                rayInfo.run = function() {
                    ...
                    q.runActions([
                        function() {
                            self.mainLabelDouble.increase(0, mySelf.value);
        ...
        if (newData.XHSNUM - data.XHSNUM > 0) {
            util.sliceNumber(newData.XHSNUM - data.XHSNUM, 5).forEach(function(d, i) {
                ...
                rayInfo.run = function() {
                    ...
                    q.runActions([
                        function() {
                            self.mainLabelDouble.increase(mySelf.value);
            ...
            self.mainLabelDouble.increase(newData.XHSNUM - data.XHSNUM);
        ...
        if (newData.EMAILNUM - data.EMAILNUM > 0) {
            ...
            self.mainLabelDouble.increase(newData.EMAILNUM - data.EMAILNUM);
        ...
        if (newData.WEBENTRY.ONE - data.WEBENTRY.ONE > 0) {
            ...
            self.mainLabelDouble.increase(newData.WEBENTRY.ONE - data.WEBENTRY.ONE);
        ...
        if (newData.WEBENTRY.TWO - data.WEBENTRY.TWO > 0) {
            ...
            self.mainLabelDouble.increase(newData.WEBENTRY.TWO - data.WEBENTRY.TWO);
        ...
        if (newData.WEBENTRY.THREE - data.WEBENTRY.THREE > 0) {
            ...
            self.mainLabelDouble.increase(newData.WEBENTRY.THREE - data.WEBENTRY.THREE);
        ...
        if (newData.WEBENTRY.FOUR - data.WEBENTRY.FOUR > 0) {
            ...
            self.mainLabelDouble.increase(newData.WEBENTRY.FOUR - data.WEBENTRY.FOUR);
        ...
        if (newData.WEBENTRY.FIVE - data.WEBENTRY.FIVE > 0) {
            ...
            self.mainLabelDouble.increase(newData.WEBENTRY.FIVE - data.WEBENTRY.FIVE);
        ...
        if (newData.ORGINAL.ONE - data.ORGINAL.ONE > 0) {
            ...
            self.mainLabelDouble.increase(0, newData.ORGINAL.ONE - data.ORGINAL.ONE);
        ...
        if (newData.ORGINAL.TWO - data.ORGINAL.TWO > 0) {
            ...
            self.mainLabelDouble.increase(0, newData.ORGINAL.TWO - data.ORGINAL.TWO);
        ...
        if (newData.ORGINAL.THREE - data.ORGINAL.THREE > 0) {
            ...
            self.mainLabelDouble.increase(0, newData.ORGINAL.THREE - data.ORGINAL.THREE);
