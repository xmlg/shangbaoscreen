...
*/
        ...
        var p0 = this.p0 = this.snapElement.path('M+18 -106 ').attr({
            stroke: '#8B8E91',
            "stroke-width": 1,
            fill: 'none',
            opacity: 1
    ...
    GalaxyTitleAtLeft.prototype.set = function(title, content, value) { //新版
        $(".galaxyText").html(content);
    };
    GalaxyTitleAtLeft.prototype.show = function() {
        $(".galaxyText").fadeIn("slow");
        this.snapElement.animate({
            opacity: 1
        }, 500);
    }
    GalaxyTitleAtLeft.prototype.hide = function() {
        $(".galaxyText").fadeOut("slow");
        this.snapElement.animate({
            opacity: 0
        }, 500);
    }
