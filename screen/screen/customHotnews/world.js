"use strict";
angular.module("worldHotnewsModule", ["ngAnimate", "httpServerModule"])
    .controller("worldHotnewsCtrl", ["$scope", "$q", "$sce", "http", "$timeout", function($scope, $q, $sce, http, $timeout) {
        initStatus();
        initData();
        /**
