	    ...
	    for (var i = 0; i < dataNews.length; i++) {
	        ...
	        for (var j = 0; j < item.REPORTS_INFO.length; j++) {
	            ...
	            if (activeIndex === news.REPORTID) {
				    ...
				    if (news.FLAG == 0) {
				        titarr.push('    <img class="flagicon" src="img2/bmx_4.png">');
				    } else if (news.FLAG == 1) {
				        titarr.push('    <img class="flagicon" src="img2/bmx_5.png">');
				    } else if (news.FLAG == 2) {
				        titarr.push('    <img class="flagicon" src="img2/bmx_6.png">');
				    } else if (news.FLAG == 3) {
				        titarr.push('    <img class="flagicon" src="img2/bmx_7.png">');
				    }

				    titarr.push('    <p id="tit1" class="tit1">' + news.STATEMENT + '</p>');
				    titarr.push('</div>');
				    $("#main_title").html(titarr.join(""));
	                $("#middle_text").html(news.content);
	                $("#GJXQ_title").html(titarr.join(""));
	                $("#GJXQ_text").html(news.content);
