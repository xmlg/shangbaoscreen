define(function(require) {
    ...
    function SubScenePlan(parent) {
        ...
        var d = 'M39 45 39 175 25 200 -795 200 -814 176 -814 40';
        var pathWayStyle = {
            stroke: "#E24E2B ",
            strokeWidth: 1,
            fill: "none",
         ...
         * @type {PathWay}
         */
        this.mainLabel = new MainLabel(this, '策', data.TOTAL);
        this.mainLabel.setPosition(496.5, 157.5);
        ...
        util.sliceNumber(newData.BOMB.ONE - data.BOMB.ONE, 5).forEach(function(d, i) {
            ...
            rayInfo.run = function() {
                self.classifyLabel1.increase(this.value, function() {
                    self.mainLabel.increase(this.value);
                }, 1);
            }
