...
(function() {
    ...
    Hotnews.prototype.getHotnews = function(success) {
        ...
        HS.httpServer("/wcm/bigdata.do?cluster_name=country_1&field=000&modelid=hotnewslist&pagesize=10&serviceid=areahotpoint&startpage=0&subjectarea=0&typeid=widget&area=" + this.type, params, "get").done(function(data) {
    ...
    function appendList(obj, data, name) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            // console.log(dom);
            templateCopy.find(".source").html(_data.FIRSTMEDIA);
