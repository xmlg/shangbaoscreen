...
function Twinkler() {
    ...
    this.twinkleAtElement = function (htmlElement, options) {
        ...
        var offX = offset.left / options.scale + width * settings.widthRatio;
        var offY = offset.top / options.scale + height * settings.heightRatio;
        var posX = position.left / options.scale + width * settings.widthRatio;
        var posY = position.top / options.scale + height * settings.heightRatio;
