zbdp.initNews = function(time) {
    ...
    var XHSUrl = '/lhjk/getJson?name=proposal';
    var nationData = '/lhjk/getJson?name=lhview';
...
zbdp.drawNews = function(data, label) {
    ...
    for (var i = 0; i < dataArr.length; i++) {
        ...
        itemSite.innerHTML = '<div class="news-item-site">'+item.ENTITYNAME+"&nbsp;&nbsp;"+format(item.PUBTIME)+'</div>';
        ...
        itemDetailWrapper.innerHTML = '<div class="news-item-detail"><a target="_blank">' + item.CONTENT + '</a></div>'
