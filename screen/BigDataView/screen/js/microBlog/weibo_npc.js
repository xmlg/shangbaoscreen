...
App.prototype.requestJson = function() {
    ...
    var microTime = getQueryString('microtime')||'';
	var self = this;
	var url = '/wcm/bigdata.do?modelid=getWeibohotPointBykeyid&serviceid=weibohotpointmgr&keyid=916&loadtime='+microTime;
...
App.prototype.convertData = function(data){
	var lists1 =[],
	    ...
	    lists4 =[],
		self =this;
	var microL = data.length,
		toggleMicroList = $('.toggleMicroList'),
		MicroList_1 = $('.MicroList_1'),
		MicroList_2 = $('.MicroList_2'),
		MicroList_3 = $('.MicroList_3'),
		MicroList_4 = $('.MicroList_4');
	window.num = 1;
	window.maxNum = 5;
	//toggleMicroList.hide();

	if(15<microL&microL<=20){
		toggleMicroList.show();
		window.maxNum = 5;
	}else if(10<microL&microL<=15 ){
		MicroList_1.show();
		MicroList_2.show();
		MicroList_3.show();
		window.maxNum = 4;
	}else if(5<microL&microL<=10 ){
		MicroList_1.show();
		MicroList_2.show();
		window.maxNum = 3;
	}else if(0<microL&microL<=5 ){
		MicroList_1.show();
		window.maxNum = 2;
	}
