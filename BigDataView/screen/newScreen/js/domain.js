...
App.prototype.requestData = function() {
    ...
    var url = connectUrl(serverDomain + 'http://111.203.35.59/cas/casData/screenJson?type=domain');
    d3.json(url, function(error, data) {
        ...
        data.Records.forEach(function(d, i) {
            ...
            self.data.push({
                value: d.avgndex,
                value2: d.maxIndex,
                title: "<a target='_blank' href='http://111.203.35.59/cas/ce/articledetail/main.do?method=detail&zbGuid="+d.zbGuid+"'>"+d.title.replace(/\n/gmi,',').replace(/\s+/g,'')+"</a>",
