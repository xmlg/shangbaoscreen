﻿zbdp.initNews = function(time) {
    ...
    var XHSUrl = '/bigScreen/hotspot/weixin?type=XHS'; //新华社接口
    var nationData = '/bigScreen/hotspot/weixin?type=NATIONAL'; //全国接口
...
zbdp.drawNews = function(data, label) {
    ...
    for (var i = 0; i < dataArr.length; i++) {
        ...
        itemSite.innerHTML = '<div class="news-item-site">' + item.author + "&nbsp;&nbsp;" + item.pubTime + "&nbsp;&nbsp;<i class='prcount'></i>" + item.thumbNum + '</div>';
